...
insert into employee values ('Franklin', 'T', 'Wong', 333445555, '1955-12-08','638-Voss-Houston-TX', 'M', 40000, 123456789, 6),
                            ('Alicia','J','Zelaya', 999887777, '1968-01-19', '3321-Castle-Sprint-TX','F',25000, 333445555, 4),
                            ...
                            ('Joyce', 'A', 'English', 453453453,'1972-07-29', '5631-Rice-Houston-TX', 'F', 25000, 987654321, 5),
...
insert into dependent values (333445555, 'Alice', 'F', '1986-04-05', 'Daughter'),
                             ...
                             (333445555,'Joy','F','1958-05-25','Spouse'),
...
-- Consultando dados de funcionário
select Bdate, Address from employee
	where Fname = 'John' and Minit = 'B' and Lname = 'Smith';
    
 -- Recuperando apartamento específico   
select * from departament  where Dname= 'Research';

-- Consultando nome de funcionarios por setores
select Fname, Lname, Address from employee, departament
	where Dname='Research' and Dnumber=Dno;

-- Consulta pessoas que estão trabalhando em quais projetos e horas
